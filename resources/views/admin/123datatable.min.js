...
(function(h) {
    ...
    function Ca(a) {
        ...
        c && Da(c);
        if (a) {
            var d = a.sZeroRecords; ! a.sEmptyTable && (d && "No data available in table" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable"); ! a.sLoadingRecords && (d && "Loading..." === b.sLoadingRecords) && F(a, a, "sZeroRecords", "sLoadingRecords");
            a.sInfoThousands && (a.sThousands = a.sInfoThousands); (a = a.sDecimal) && c !== a && Da(a)
        }
    }
    function eb(a) {
        A(a, "ordering", "bSort");
        ...
        c = a.length; b < c; b++) a[b] && J(n.models.oSearch, a[b])
    }
    function fb(a) {
    ...
    function Ia(a, b, c, d) {
        ...
        G = function(a) {
            ...
            j && j._bAttrSrc ? (N(j.mData._)(d, m), t(j.mData.sort, a), t(j.mData.type, a), t(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)), j._setter(d, m)) : d[i] = m;
            i++
        };
        if (f) for (; f;) {
    ...
    function kb(a) {
        ...
        f.sTitle != d[0].innerHTML && d(f.sTitle),
        Na(a, "header")(a, d, f, m);
        i && ea(a.aoHeader, g);
    ...
    function lb(a) {
        return a.bAjaxDataGet ? (a.iDraw++, C(a, !0), sa(a, ub(a),
        function(b) {
            vb(a, b)
        }), !1) : !0
    }
    ...
    function pb(a) {
        ...
        i = h("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", g ? Oa(f, g) : f).on("keypress.DT",
        function(a) {
    ...
    function yb(a) {
        for (var b = n.ext.search,
        c = a.aiDisplay,
        d, e, f = 0,
        g = b.length; f < g; f++) {
            for (var j = [], i = 0, m = c.length; i < m; i++) e = c[i],
            d = a.aoData[e],
    ...
    function xb(a, b, c, d, e, f) {
        if ("" !== b) {
            for (var g = [], j = a.aiDisplay, d = Pa(b, d, e, f), e = 0; e < j.length; e++) b = a.aoData[j[e]]._aFilterData[c],
            d.test(b) && g.push(j[e]);
            a.aiDisplay = g
        }
    }
    ...
    function ua(a, b) {
        a._bInitComplete = !0; (b || a.oInit.aaData) && $(a);
    ...
    function la(a) {
        ...
        $(a);
            ...
            if (p.outerWidth() < f) {
                ...
                if (U && (j.scrollHeight > j.offsetHeight || "scroll" == l.css("overflow-y"))) r.width = v(Q - b); ("" === c || "" !== d) && K(a, 1, "Possible column misalignment", 6)
            } else Q = "100%";
            q.width = v(Q);
            g.width = v(Q);
            u && (a.nScrollFoot.style.width = v(Q)); ! e && U && (q.height = v(s.offsetHeight + b));
            c = p.outerWidth();
            m[0].style.width = v(c);
            i.width = v(c);
    ...
    function Fa(a) {
        ...
        o,
        p = a.oBrowser,
        d = p.bScrollOversize; (n = b.style.width) && -1 !== n.indexOf("%") && (l = n);
        for (n = 0; n < i.length; n++) o = c[i[n]],
        null !== o.sWidth && (o.sWidth = Eb(o.sWidthOrig, k), t = !0);
        if (d || !t && !f && !e && j == V(a) && j == m.length) for (n = 0; n < j; n++) i = aa(a, n),
        null !== i && (c[i].sWidth = v(m.eq(n).width()));
            ...
            if (a.aoData.length) for (n = 0; n < i.length; n++) t = i[n],
            o = c[t],
            ...
            for (n = e = 0; n < i.length; n++) k = h(m[n]),
    ...
    function Ib(a) {
        ...
        e = X(a), a = a.oLanguage.oAria, f = 0, g = d.length; f < g; f++) {
            c = d[f];
            var j = c.asSorting;
    ...
    function Hb(a, b) {
        ...
        for (var f, g = n.ext.type.order[c.sType + "-pre"], j = 0, i = a.aoData.length; j < i; j++) if (c = a.aoData[j], c._aSortData || (c._aSortData = []), !c._aSortData[b] || d) f = d ? e[j] : B(a, j, b, "sort"),
    ...
    function Da(a) {
        ...
        function(b, c) {
            ...
            b.match(/^html\-/) && (x.type.search[b + a] = x.type.search)
        })
    }
    function Lb(a) {
        return function() {
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                ...
                e = function() {
                    ...
                    z(p, "aoDrawCallback",
                    function() { (p.bSorted || y(p) === "ssp" || U.bDeferRender) && wa(p)
                    },
                    "sc");
    ...
    Ba = function(a, b) {
        ...
        } else if ("current" == c || "applied" == c) if ("none" == j) f = e.slice();
    ...
    Tb = function(a, b) {
        ...
        if (c.length && a.length) {
            ...
            if (d._details) { (d._detailsShow = b) ? d._details.insertAfter(d.nTr) : d._details.detach();
                ...
                function(a, b) {
                    if (e === b) for (var c, d = V(b), f = 0, h = g.length; f < h; f++) c = g[f],
                    c._details && c._details.children("td[colspan]").attr("colspan", d)
                }), f.on("destroy.dt.DT_details",
                function(a, b) {
                    if (e === b) for (var c = 0,
                    d = g.length; c < d; c++) g[c]._details && db(f, c)
                }))
            }
        }
    };
        ...
        function(b, c) {
            ...
            if (a !== k && g.bVisible !== a) {
                if (a) {
                    ...
                    i = 0;
                    for (m = j.length; i < m; i++) l = j[i].nTr,
                    f = j[i].anCells,
...
(function(b) {
    ...
    f.ext.renderer.pageButton.bootstrap = function(a, h, r, s, j, n) {
        ...
        q = function(d, f) {
            ...
            l = 0;
            for (h = f.length; l < h; l++) if (c = f[l], b.isArray(c)) q(d, c);
            else {
                g = e = "";
                switch (c) {
                case "ellipsis":
