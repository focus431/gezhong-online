	...
	document.addEventListener('DOMContentLoaded', function() {
		...
		$('.datatable').DataTable({
			...
			ajax: function(data, callback, settings) {
				...
				fetch(`/get-users/mentee?sortField=${sortField}&sortDirection=${sortDirection}&page=${currentPage}&perPage=${perPage}&search=${data.search.value}`)


					// fetch(`/get-mentees?sortField=${sortField}&sortDirection=${sortDirection}&page=${currentPage}&perPage=${perPage}`)
