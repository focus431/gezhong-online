										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="../assets_admin/img/user/user6.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="../assets_admin/img/user/user7.jpg" alt="User Image"></a>
