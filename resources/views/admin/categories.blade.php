										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												<tr>
													...
													<td class="text-end">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-bs-toggle="modal" href="#edit_modal">
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="form-content p-2">
							...
							<div class="card">
								<div class="card-body">
					                <form id="update_category" method="get" autocomplete="off" enctype="multipart/form-data" novalidate="novalidate" class="bv-form"><button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
